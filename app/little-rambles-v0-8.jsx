    ...
    <div className="lr-root">
      ...
      <div className="phone">
        <header className="hdr">
          <div className="hdr-brand"><span className="hdr-logo">〰️</span><span className="hdr-name">Little Rambles</span><span className="ver">v0.8</span></div>
...
/* ------------------------- Pieces ------------------------------ */
const CATEGORY_ART = {
  water: { c1: "#C8E4EE", c2: "#8FB3C0", shapes: (<g><circle cx="278" cy="24" r="14" fill="#E9A23B" /><path d="M0,66 Q40,54 80,66 T160,66 T240,66 T320,66 V100 H0 Z" fill="#FFFFFF" opacity="0.45" /><path d="M0,78 Q40,68 80,78 T160,78 T240,78 T320,78 V100 H0 Z" fill="#FFFFFF" opacity="0.6" /></g>) },
  stories: { c1: "#F4EAD8", c2: "#E6D3B4", shapes: (<g><rect x="200" y="34" width="52" height="38" rx="5" fill="#FFFFFF" transform="rotate(-8 226 53)" /><rect x="248" y="30" width="52" height="38" rx="5" fill="#FFF7EA" transform="rotate(7 274 49)" /><circle cx="60" cy="20" r="10" fill="#E9A23B" opacity="0.8" /></g>) },
  music: { c1: "#F6DDD5", c2: "#E5AFA3", shapes: (<g><circle cx="238" cy="62" r="9" fill="#29382F" /><rect x="245" y="24" width="4" height="38" fill="#29382F" /><circle cx="282" cy="52" r="9" fill="#29382F" /><rect x="289" y="16" width="4" height="36" fill="#29382F" /><rect x="245" y="20" width="48" height="6" rx="3" fill="#29382F" /></g>) },
  animals: { c1: "#E4EDE2", c2: "#B9CFB6", shapes: (<g><ellipse cx="90" cy="108" rx="130" ry="42" fill="#9DBD9A" opacity="0.7" /><ellipse cx="270" cy="112" rx="120" ry="46" fill="#8FB08C" opacity="0.8" /><circle cx="286" cy="22" r="12" fill="#E9A23B" /></g>) },
  nature: { c1: "#D6E7DC", c2: "#A3C6B0", shapes: (<g><polygon points="250,72 268,30 286,72" fill="#2F5138" opacity="0.85" /><polygon points="284,76 298,44 312,76" fill="#2F5138" opacity="0.7" /><circle cx="52" cy="20" r="11" fill="#E9A23B" /><ellipse cx="160" cy="112" rx="200" ry="40" fill="#8FB08C" opacity="0.5" /></g>) },
  sensory: { c1: "#FBEAC9", c2: "#F3D9A4", shapes: (<g><rect x="210" y="24" width="10" height="10" rx="2" fill="#8FB3C0" transform="rotate(20 215 29)" /><rect x="250" y="50" width="10" height="10" rx="2" fill="#E5AFA3" transform="rotate(-15 255 55)" /><rect x="286" y="26" width="10" height="10" rx="2" fill="#2F5138" transform="rotate(30 291 31)" /><circle cx="236" cy="70" r="6" fill="#E9A23B" /><circle cx="292" cy="64" r="5" fill="#8FB3C0" /></g>) },
  art: { c1: "#FDF3EC", c2: "#F0CFC2", shapes: (<g><circle cx="240" cy="46" r="20" fill="#E9A23B" opacity="0.75" /><circle cx="276" cy="66" r="16" fill="#8FB3C0" opacity="0.75" /><circle cx="292" cy="34" r="11" fill="#2F5138" opacity="0.55" /></g>) },
  playground: { c1: "#DCEAF1", c2: "#AFCBD8", shapes: (<g><polygon points="230,80 268,32 276,38 246,80" fill="#FFFFFF" opacity="0.9" /><rect x="266" y="30" width="6" height="50" fill="#29382F" opacity="0.7" /><circle cx="60" cy="20" r="11" fill="#E9A23B" /></g>) },
  science: { c1: "#2E4038", c2: "#20302A", shapes: (<g><circle cx="250" cy="40" r="16" fill="#E9A23B" opacity="0.9" /><ellipse cx="250" cy="40" rx="30" ry="9" fill="none" stroke="#F6F5EF" strokeWidth="3" opacity="0.8" /><circle cx="300" cy="20" r="2.5" fill="#F6F5EF" /><circle cx="210" cy="18" r="2" fill="#F6F5EF" /><circle cx="300" cy="70" r="2" fill="#F6F5EF" /></g>) },
};

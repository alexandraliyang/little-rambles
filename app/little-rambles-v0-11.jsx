    ...
    <div className="lr-root">
      ...
      <div className="phone">
        <header className="hdr">
          <div className="hdr-brand"><span className="hdr-logo">〰️</span><span className="hdr-name">Little Rambles</span><span className="ver">v0.11</span></div>

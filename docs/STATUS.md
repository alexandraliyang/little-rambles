...
| v0.5.x–0.6 QA sign-off | Manual Test Lead | Script covers 0.5.1→0.7 (15 checks) | Run docs/qa/v0-5-test-script.md on v0.6 | Founder |
...
## Done this cycle
Repo live (27→ files) · Phase 0 closed w/ debts · D4 competitive scan · ADR-0008 survey method · ADR-0009 parallel tracks · ADR-0010 team charter · v0.4 (variety + deck) · v0.5.1 · v0.6/0.6.1 (pin + env matrix) · v0.7 (Snap: capture-moment attach)

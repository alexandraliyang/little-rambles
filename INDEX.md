...
| `app/little-rambles-v0-8.jsx` | Current working prototype (illustrated banners + Snap + pin + photo journal) | [AI-GEN, ASSUMPTION-driven] | Canonical build |
...
| `app/little-rambles-v0-7.jsx`, `v0-6.jsx`, `v0-5.jsx`, `v0-4.jsx`, `v0-3.jsx`, `v0-2.jsx`, `v0-1.jsx`, `prototype.jsx` | Prior versions | [AI-GEN] | Superseded — git history is now the real archive |
